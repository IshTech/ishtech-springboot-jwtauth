package fi.ishtech.springboot.jwtauth.config;
...
import fi.ishtech.springboot.jwtauth.jwt.JwtAuthenticationFilter;
...
public class WebSecurityConfig {
	 ...
	 *
	 * # one
	 * fi.ishtech.springboot.jwtauth.permitted-urls=/first-api
	 *
	 * # multiple (comma-separated)
	 * fi.ishtech.springboot.jwtauth.permitted-urls=/first-api,/second-api,/third-api
	 * </pre>
	 */
	@Value("${fi.ishtech.springboot.jwtauth.permitted-urls:}")
	 ...
	 * </pre>
	 */
	@Value("${fi.ishtech.springboot.jwtauth.permit-swagger-urls:false}")
	 ...
	 * </pre>
	 */
	@Value("${fi.ishtech.springboot.jwtauth.cors.allowed-origins:}")
	 ...
	 * Default: all<br>
	 */
	@Value("${fi.ishtech.springboot.jwtauth.cors.allowed-methods:GET,POST,PUT,DELETE,OPTIONS}")
	 ...
	 * Default: all<br>
	 */
	@Value("${fi.ishtech.springboot.jwtauth.cors.allowed-headers:*}")
